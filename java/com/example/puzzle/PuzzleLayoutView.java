...
public class PuzzleLayoutView extends RelativeLayout implements View.OnClickListener {
    ...
    private void init() {
        mMargin = (int) TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, 3,
                getResources().getDisplayMetrics());//将dp/xp转化为px
    ...
    private void countTimeBaseLevel() {
        mTime = (int) Math.pow(2, level) * 40;//第一关80秒 第二关:160 第三关:240
    }
    ...
    private void checkSuccess() {
        ...
        if (isSuccess) {
            ...
            Log.e("TAG", "SUCCESS");
            Toast.makeText(getContext(), "恭喜你，通关成功！！！", Toast.LENGTH_LONG).show();
...
//            handler.removeMessages(TIME_CHANGED);//进入下一关时的时间
//            Log.e("TAG", "SUCCESS");
//            Toast.makeText(getContext(), "恭喜你，通关成功！！！进入下一关", Toast.LENGTH_LONG).show();
//            handler.sendEmptyMessage(NEXT_LEVEL);
//        }
//    }
